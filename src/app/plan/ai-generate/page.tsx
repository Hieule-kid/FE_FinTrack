...
const PROMPT_SUGGESTIONS = [
  "I earn 20 million VND per month. I want to save for a vacation in 6 months.",
  "I earn 15 million VND/month. Help me plan to save for a house down payment over 3 years.",
  "I want to save 50 million VND for an emergency fund in 12 months. My income is 25 million VND.",
];
    ...
    return (
      <PageContainer className="flex flex-col items-center py-10 gap-8">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <div>
            <Typography as="h1" variant="h1" className="text-[28px]">AI Plan Generator</Typography>
            <Typography variant="muted" className="mt-1 text-[15px]">
              Describe your situation — AI builds a personalised budget and savings plan
            </Typography>
          </div>
        </div>
        ...
        <Card className="w-full max-w-[620px] flex flex-col gap-5 p-7">
          ...
          <div className="flex flex-col gap-2">
            <Typography as="label" variant="label">Try an example</Typography>
            <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-1.5">
            <textarea
              rows={4}
              placeholder="e.g. I earn 20 million VND per month. I want to save for a vacation in 6 months."
              value={prompt}
  ...
  return (
    <PageContainer className="flex flex-col items-center py-10 gap-6">
      ...
      <div className="flex flex-col items-center gap-2 text-center">
        <Typography as="h1" variant="h1" className="text-[24px]">Your AI Budget Plan</Typography>
        <Typography variant="muted" className="text-[14px] max-w-[480px]">
          Review the breakdown, adjust if needed, then create your savings plan.
        </Typography>
      </div>
      ...
      <Card className="w-full max-w-[620px] flex flex-col gap-5 p-7">
        ...
        >
          <div>
            <div className="text-[12px] text-[var(--brand)] font-medium uppercase tracking-wide">Savings per month</div>
        ...
        {/* Goal Category */}
        <div className="flex flex-col gap-2">
          <Typography as="label" variant="label">Goal Category</Typography>
        ...
        {/* Duration */}
        <div className="flex flex-col gap-1.5">
          <Typography as="label" variant="label">Duration (months)</Typography>
          <div className="flex items-center gap-3">
            <Input
              type="number"
              min={1}
